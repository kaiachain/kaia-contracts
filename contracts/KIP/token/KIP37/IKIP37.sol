 ...
 * http://kips.kaia.foundation/KIPs/kip-37#kip37-interface[KIP].
 *
 */
interface IKIP37 is IKIP13 {
     ...
     * http://kips.kaia.foundation/KIPs/kip-37#metadata-extension[guarantees] that `value` will equal the value
